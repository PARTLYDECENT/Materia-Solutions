...
// Pure generative darkness, cranked to the absolute max.
// ═══════════════════════════════════════════════════════════════
...
(function () {
    ...
    let reverbSend = null;
    let isPlaying = false;
    let bpm = 175; // Cranked BPM for wickeder vibes
    let stepDuration;
    ...
    function playFMBass(time, chordRoot, tension) {
        ...
        // Distortion stage
        const dist = ctx.createWaveShaper();
        dist.curve = makeSCurveDistortion(4096, lerp(150, 400, tension));
        dist.oversample = '4x';
    ...
    const DRUM_PROB = {
        ...
        kick:            [1.00, 0.20, 0.80, 0.15, 1.00, 0.20, 0.80, 0.10, 1.00, 0.20, 0.80, 0.15, 1.00, 0.20, 0.50, 0.20],
        snare:           [0.20, 0.00, 0.00, 0.00, 1.00, 0.00, 0.00, 0.15, 0.20, 0.00, 0.00, 0.00, 1.00, 0.00, 0.00, 0.15],
        hat:             [0.95, 0.80, 0.95, 0.80, 0.95, 0.85, 0.95, 0.90, 0.95, 0.80, 0.95, 0.85, 0.95, 0.90, 0.95, 0.95],
        metal:           [0.40, 0.10, 0.20, 0.80, 0.20, 0.10, 1.00, 0.20, 0.40, 0.10, 0.20, 0.80, 0.20, 0.10, 0.80, 0.30],
    };
    ...
    window.MateriaMusic5 = { start, stop };
