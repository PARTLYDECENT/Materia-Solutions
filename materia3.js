...
(function () {
    ...
    function buildUI() {
        ...
        btn.id = 'materia3-music-btn';
        btn.innerHTML = '✨';
        btn.title = 'Toggle Ethereal Ambient Engine';
        ...
        style.textContent = `
            ...
            #materia3-music-btn.playing {
                animation: lightPulse 2.5s ease-in-out infinite;
                border-color: rgba(150, 230, 255, 0.8);
                color: #ffffff;
            }
            @keyframes lightPulse {
                0%, 100% { box-shadow: 0 0 15px rgba(100, 220, 255, 0.2); }
                50% { box-shadow: 0 0 40px rgba(100, 220, 255, 0.6); }
            }
        `;
        ...
        btn.addEventListener('click', () => {
            ...
            if (window.MateriaMusic2 && window.MateriaMusic2.stop) {
                ...
                const darkBtn = document.getElementById('materia2-music-btn');
                if (darkBtn) {
                    darkBtn.classList.remove('playing');
                    darkBtn.innerHTML = '🔊';
                }
            }
